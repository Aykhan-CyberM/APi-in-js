...
fetch("https://dummyjson.com/products")
  ...
  .then((x) => {
    ...
    renderDataArray(x.products)
  });

function renderDataArray(dataArray) {
  dataArray.forEach((product) => {
    ...
    const imagesPart = document.createElement("img")
    ...
    imagesPart.src = image;

    card.appendChild(imagesPart)
